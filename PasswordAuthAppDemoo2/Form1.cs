...
namespace PasswordAuthAppDemoo2
{
    public partial class Form1 : Form
    {
        ...
        private void GenerateNewPassword()
        {
            ...
            string totpPassword2 = Base64Encode(totp2.ComputeTotp());
            string hotpPassword2 = Base64Encode(hotp2.ComputeHOTP(counter));
            labelGeneratedPassword.Text = $"TOTP2: {totpPassword2} \nHOTP2: {hotpPassword2}";
            timeLeft = 60;
        }
